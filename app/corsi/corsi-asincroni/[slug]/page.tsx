...
const CORSI: CorsoDetail[] = [
  ...
  // ── LATINO ──────────────────────────────────────────
  {
    ...
    latinCertRef: 'Livello A1 (Latin Cert) — Primo contatto con la lingua latina: sistema di casi, prime declinazioni, verbo esse, presente indicativo. Compatibile con Familia Romana capitoli I–XIII.',
    whatYouLearn: [
      ...
      'Accedere autonomamente a testi graduati per il livello A1, inclusi passi adattati da Familia Romana',
    ],
    syllabus: [
      ...
      { n: 11, titolo: 'Testi autentici adattati', desc: 'Lettura guidata da Familia Romana capitoli I–VI. Commento lessicale e morfologico. Comprensione globale senza dizionario.' },
...

  {
    ...
    latinCertRef: 'Livello A1 avanzato (Latin Cert) — Completamento del sistema nominale latino. Testi da Familia Romana capitoli VII–XIII.',
    whatYouLearn: [
...

  {
    ...
    latinCertRef: 'Livello A2 (Latin Cert) — Completamento del sistema nominale. Verbi deponenti, participio, gerundio. Testi da Familia Romana capitoli XIV–XX.',
    whatYouLearn: [
...

  {
    ...
    latinCertRef: 'Livello A2 avanzato (Latin Cert) — Ablativo assoluto, frasi infinitive, gerundio. Testi da Familia Romana capitoli XXI–XXVI.',
    whatYouLearn: [
