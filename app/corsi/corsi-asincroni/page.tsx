...
const CORSI: Corso[] = [
  ...
  { id:'breve-japonia', slug:'breve-japonia', lang:'Corsi Brevi', level:'Autori Latini', title:'Terra Japonia: un viaggio in latino nel Giappone del Cinquecento', description:'Un testo in latino del XVI secolo che racconta il Giappone. Lettura guidata. 4 ore.', priceEur:2900, hours:4, teacher:'Marta Giannico', available:false, idc:440 },
  { id:'breve-metrica', slug:'breve-metrica', lang:'Corsi Brevi', level:'Metodo', title:'Il ritmo del verso: approccio neuroscientifico alla metrica classica', description:'Come il cervello elabora il ritmo poetico. Metrica latina e greca in chiave cognitiva. 4 ore.', priceEur:2900, hours:4, teacher:'Giampiero Marchi', available:false, idc:441 },
  { id:'breve-voci-vangeli', slug:'breve-voci-vangeli', lang:'Corsi Brevi', level:'Bibbia e Antichità', title:'Voci dei Vangeli: un viaggio dalle Radici alla Rivelazione', description:'I Vangeli nel loro contesto storico, linguistico e culturale. 6 ore.', priceEur:6000, hours:6, teacher:'Alberto Bibbiani', available:false, idc:337 },
  { id:'breve-storie-latine', slug:'breve-storie-latine', lang:'Corsi Brevi', level:'Autori Latini', title:"Dall'Antico al Moderno: Storie in Lingua Latina", description:'Lettura di testi latini medievali e moderni che narrano storie di ogni epoca. 6 ore.', priceEur:6000, hours:6, teacher:'Maria Di Puorto', available:false, idc:338 },
  { id:'breve-buona-novella', slug:'breve-buona-novella', lang:'Corsi Brevi', level:'Bibbia e Antichità', title:'La Buona Novella tra greco e latino', description:'Il Vangelo nelle sue versioni greca e latina: confronto linguistico e teologico. 6 ore.', priceEur:7000, hours:6, teacher:'Giampiero Marchi', available:false, idc:276 },
  { id:'breve-padri-chiesa', slug:'breve-padri-chiesa', lang:'Corsi Brevi', level:'Bibbia e Antichità', title:'Il Vangelo attraverso i Padri della Chiesa', description:"Lettura e interpretazione patristica del Vangelo: Agostino, Gregorio, Ambrogio. 6 ore.", priceEur:7000, hours:6, teacher:'Andrés Reyes Cabrera', available:false, idc:286 },
  ...
  { id:'breve-nubia-egitto', slug:'breve-nubia-egitto', lang:'Corsi Brevi', level:'Archeologia', title:'Tra due Mondi: Nubia ed Egitto sulla linea di confine', description:'Il rapporto tra Egitto e Nubia: conflitto, scambio culturale, ibridazione artistica. 6 ore.', priceEur:9000, hours:6, teacher:'Francesca Iannarilli', available:false, idc:340 },
  { id:'breve-archeologia', slug:'breve-archeologia', lang:'Corsi Brevi', level:'Archeologia', title:"Testimonianze del Tempo: un viaggio nell'Archeologia Applicata", description:'Come si fa archeologia: metodo, scavo, interpretazione. 4 ore.', priceEur:9000, hours:4, teacher:'Roberto Melfi', available:false, idc:341 },
  { id:'breve-passione', slug:'breve-passione', lang:'Corsi Brevi', level:'Bibbia e Antichità', title:'Prospettive di Passione: gli ultimi giorni di Gesù nei Vangeli', description:'Confronto sinottico della Passione nei quattro Vangeli: stile, teologia, storicità. 6 ore.', priceEur:9000, hours:6, teacher:'Alberto Bibbiani', available:false, idc:349 },
  { id:'breve-pompei', slug:'breve-pompei', lang:'Corsi Brevi', level:'Archeologia', title:'Voci silenziose di Pompei: scoperte epigrafiche nella città sepolta', description:'Le iscrizioni di Pompei: graffiti, tituli, dipinti elettorali. Lettura e contesto. 8 ore.', priceEur:9000, hours:8, teacher:'Marta Giannico', available:false, idc:350 },
  { id:'breve-miniera-luna', slug:'breve-miniera-luna', lang:'Corsi Brevi', level:'Filosofia Antica', title:"Dalla Miniera alla Luna: Pirandello e Verga tra esistenza e letteratura", description:'Percorso letterario tra i due grandi autori siciliani: tema del destino, della natura, della lotta. 6 ore.', priceEur:9000, hours:6, teacher:'Alessandra Chiusaroli', available:false, idc:361 },
  { id:'breve-algoritmica', slug:'breve-algoritmica', lang:'Corsi Brevi', level:'Filosofia Antica', title:"L'Algoritmica dell'Essere: filosofia nell'Intelligenza Artificiale", description:"Esplorazioni filosofiche ai confini tra intelligenza artificiale e pensiero antico. 6 ore.", priceEur:9000, hours:6, teacher:'Giulio Bianchi', available:false, idc:362 },
  { id:'breve-voci-femminili', slug:'breve-voci-femminili', lang:'Corsi Brevi', level:'Bibbia e Antichità', title:'Dal Margine al Centro: Voci Femminili nei Vangeli', description:'Le donne nei Vangeli: protagoniste dimenticate della storia cristiana. 4 ore.', priceEur:9000, hours:4, teacher:'Alberto Bibbiani', available:false, idc:369 },
  { id:'breve-nilo', slug:'breve-nilo', lang:'Corsi Brevi', level:'Archeologia', title:"Aldilà e Al-di-qua del Nilo: l'Antico Egitto tra vita e morte", description:"Il concetto egiziano di morte, aldilà e resurrezione. Testi funerari e iconografia. 8 ore.", priceEur:10000, hours:8, teacher:'Francesca Iannarilli', available:false, idc:403 },
